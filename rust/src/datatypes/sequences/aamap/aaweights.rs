...
/// 2. Not be all zero
/// 3. Have a finite sum
pub struct AAWeights(AAMap<f64>);
impl AAWeights {
    ...
    pub fn new(weights: &AAMap<f64>) -> Result<&Self, WeightError> {
        ...
        let this = unsafe { mem::transmute::<&AAMap<f64>, &Self>(weights) };
        Ok(this)
    }
}
impl Deref for AAWeights {
    type Target = AAMap<f64>;
